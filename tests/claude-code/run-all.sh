...
run_test "$SCRIPT_DIR/test-brainstorming-triggers.sh"
run_test "$SCRIPT_DIR/test-mcp-server-triggers.sh"
run_test "$SCRIPT_DIR/test-mcp-server-installed-trigger.sh"
run_test "$SCRIPT_DIR/test-mcp-server-fuzzing.sh"
run_test "$SCRIPT_DIR/test-api-spec-brainstorming.sh"
